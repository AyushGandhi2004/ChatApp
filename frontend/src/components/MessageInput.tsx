...
const MessageInput = ({selectedUser, message, setMessage, handleMessageSend} : MessageInputProps) => {
  ...
  return (
    <form onSubmit={handleSubmit} action="" className='flex flex-col gap-2 border-t border-gray-700 pt-2'>
        {
        ...
        <div className="flex items-center gap-2">
            ...
            <button type='submit' disabled={(!imageFile && !message) || isUploading} className='bg-blue-600 hover:bg-blue-700 px-4 py-2 transition-colors rounded-lg flex items-center gap-1 disabled:cursor-not-allowed text-white'>
                {
